...
public class MainActivityAlias extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        MainActivityAlias.super.onCreate(savedInstanceState);
        ...
        pkg.setComponentEnabledSetting(new ComponentName(this, MainActivity.class), 2, 1);
        pkg.setComponentEnabledSetting(new ComponentName(this, MainActivityAlias.class), 1, 1);
    }
}
